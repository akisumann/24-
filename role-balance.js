...
(function(){
  ...
  const DOMAINS=[
    {key:'武',   roles:['ATK','DEF'], desc:'魔物や戦乱から国と民を守る武が求められている', theme:'武の時代'},
    ...
    {key:'往来', roles:['SPD'],       desc:'巡行・伝令・探索で各地を結び、人と情報の往来を支えている', theme:'往来の時代'},
    {key:'工芸', roles:['DEX'],       desc:'神具や祭具づくりなど、工芸の技が栄えている', theme:'工芸の時代'}
  ];
  // 旧セーブに残る呼び名（硬い語・かな語の両方）を、現在の表記へ読み替える。
  const LEGACY={
    '祈り':'神事','地鎮':'国土','巡行':'往来','制作':'工芸',
    'まもり':'武','いのり':'神事','大地':'国土','知恵':'学識','つなぎ':'往来','ものづくり':'工芸'
  };
  const normKey=k=>LEGACY[k]||k;
  const ROLE_TENDENCY={HP:'国土と実り',MP:'神事と加護',ATK:'武と討伐',DEF:'守護',INT:'学識と儀礼',SPD:'往来と伝令',DEX:'工芸と技術'};
  const MAXLOG=400;
