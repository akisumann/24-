...
(function(){
  ...
  function renderCeremonyUI(){
    ...
    el.innerHTML=`
      ...
      ${(function(){const f=c.mothers.find(m=>m.favored);return f?`<div class="callout">神は十人すべてを抱いたが、最も激しく求めたのは<b>${f.name}</b>（バスト${f.bust}・ヒップ${f.hip}）であった——その最寵が、娘・${f.child}に宿る。</div>`:'';})()}
